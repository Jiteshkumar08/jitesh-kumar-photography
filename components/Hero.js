...
export default function Hero() {
  ...
  return (
    <div className="flex flex-col md:flex-row justify-center items-start overflow-hidden relative">
      {/* Text container */}
      ...
      {/* Image container */}
      <div className="relative w-full md:w-1/2 -mr-40 mt-20 self-center right-6">
        <div className="w-3/4 ">
